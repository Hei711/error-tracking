...
## Features
You can view errors by browsing, searching for an error using keywords or usng tags to narrw down the search
You can also log an error
Persistent storage using firebase
Tailored for the code blossom curriculum
...
Can be used as the team's knowledge base
Learning tool because its grouped in code blossom's curriculum chapters
